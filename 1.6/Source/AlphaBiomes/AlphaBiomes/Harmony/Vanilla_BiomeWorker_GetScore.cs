...
namespace AlphaBiomes
{
    ...
    [HarmonyPatch(typeof(BiomeWorker_GlacialPlain))]
    [HarmonyPatch("GetScore")]
    public static class BiomeWorker_GlacialPlain_GetScore_Patch
    {
        [HarmonyPostfix]
        public static void RemoveGlacial(ref float __result)
        {
            if (AlphaBiomes_Settings_Odyssey.AB_RemoveOdysseyBiomes) { __result = -100f; }
        }
    }
    [HarmonyPatch(typeof(BiomeWorker_Glowforest))]
    [HarmonyPatch("GetScore")]
    public static class BiomeWorker_Glowforest_GetScore_Patch
    {
        [HarmonyPostfix]
        public static void RemoveGlowforest(ref float __result)
        {
            if (AlphaBiomes_Settings_Odyssey.AB_RemoveOdysseyBiomes) { __result = -100f; }
        }
    }
    [HarmonyPatch(typeof(BiomeWorker_Grasslands))]
    [HarmonyPatch("GetScore")]
    public static class BiomeWorker_Grasslands_GetScore_Patch
    {
        [HarmonyPostfix]
        public static void RemoveGrasslands(ref float __result)
        {
            if (AlphaBiomes_Settings_Odyssey.AB_RemoveOdysseyBiomes) { __result = -100f; }
        }
    }
    [HarmonyPatch(typeof(BiomeWorker_LavaField))]
    [HarmonyPatch("GetScore")]
    public static class BiomeWorker_LavaField_GetScore_Patch
    {
        [HarmonyPostfix]
        public static void RemoveLavaField(ref float __result)
        {
            if (AlphaBiomes_Settings_Odyssey.AB_RemoveOdysseyBiomes) { __result = -100f; }
        }
    }
    [HarmonyPatch(typeof(BiomeWorker_Scarlands))]
    [HarmonyPatch("GetScore")]
    public static class BiomeWorker_Scarlands_GetScore_Patch
    {
        [HarmonyPostfix]
        public static void RemoveScarlands(ref float __result)
        {
            if (AlphaBiomes_Settings_Odyssey.AB_RemoveOdysseyBiomes) { __result = -100f; }
        }
    }
