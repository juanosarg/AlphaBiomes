...
namespace AlphaBiomes
{
    ...
    public class CompAlcyoniteSolar: CompPowerPlantSolar
    {
        ...
        protected override float DesiredPowerOutput
        {
            get
            {
                return Mathf.Lerp(0f, 1700f, this.parent.Map.skyManager.CurSkyGlow) * this.RoofedPowerOutputFactor * this.WeatherFactor;
            }
        }
        ...
        public override void PostDraw()
        {
           // base.base.PostDraw();
            ...
            r.fillPercent = DesiredPowerOutput / FullSunPower;
        ...
        private const float FullSunPowerWithFog = 2550f;
